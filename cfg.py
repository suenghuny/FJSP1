...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=84, help="GTN 해당")
    ...
    parser.add_argument("--epsilon", type=float, default=0.3, help="initial value of epsilon greedy")
