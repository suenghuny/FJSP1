...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_comm", type=int, default=132, help="")
    parser.add_argument("--hidden_size_Q", type=int, default=140, help="GTN 해당")
    parser.add_argument("--hidden_size_meta_path", type=int, default=42, help="GTN 해당")
    parser.add_argument("--n_representation_job", type=int, default=24, help="GTN 해당")
    parser.add_argument("--n_representation_machine", type=int, default=108, help="")
