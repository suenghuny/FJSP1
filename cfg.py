...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=24, help="GTN 해당")
    parser.add_argument("--hidden_size_comm", type=int, default=30, help="")
    parser.add_argument("--hidden_size_Q", type=int, default=64, help="GTN 해당")
    ...
    parser.add_argument("--n_representation_machine", type=int, default=36, help="")
