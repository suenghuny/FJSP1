...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=128, help="GTN 해당")
    parser.add_argument("--hidden_size_comm", type=int, default=54, help="")
    ...
    parser.add_argument("--n_representation_job", type=int, default=56, help="GTN 해당")
    parser.add_argument("--n_representation_machine", type=int, default=24, help="")
    ...
    parser.add_argument("--gamma", type=float, default=0.92, help="discount ratio")
    ...
    parser.add_argument("--epsilon", type=float, default=0.1, help="initial value of epsilon greedy")
