...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=28, help="GTN 해당")
    ...
    parser.add_argument("--n_representation_machine", type=int, default=48, help="")
    ...
    parser.add_argument("--train_start", type=int, default=500, help="number of train start")
    parser.add_argument("--epsilon", type=float, default=0.2, help="initial value of epsilon greedy")
