...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_comm", type=int, default=72, help="")
    parser.add_argument("--n_representation_job", type=int, default=72, help="GTN 해당")
    parser.add_argument("--n_representation_machine", type=int, default=128, help="")
    ...
    parser.add_argument("--train_start", type=int, default=50, help="number of train start")
